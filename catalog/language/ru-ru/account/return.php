...
$_['text_message']			= '<p>Мы получили Ваш запрос на возврат.</p><p> Уведомления о статусе запроса вы получите на ваш e-mail. Спасибо!</p>';
...
$_['text_empty']				= 'У Вас не было ни одного возврата товаров, за что мы Вам очень благодарны!';
