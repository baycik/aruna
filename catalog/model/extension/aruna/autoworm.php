...
class ModelExtensionArunaAutoWorm extends Model {
    ...
    private $filter_whitelist=[
        ...
        'Высота искрогасителя, мм'=>'Высота',
        'Высота подхвата, мм'=>'Высота',
        'Высота подъема, мм'=>'Высота',
        'Высота, мм'=>'Высота',
        'Выходное напряжение В'=>'Напряжение',
        'Вольтаж, V'=>'Напряжение',
        'Выходное напряжение, В'=>'Напряжение',
        'Диаметр входного отверстия искрогасителя, мм'=>'',
        'Диаметр искрогасителя, мм'=>'Диаметр',
        'Диаметр обода, мм'=>'Диаметр',
        'Диаметр посадочный, мм'=>'Диаметр',
        'Диаметр прутка, мм'=>'Диаметр',
        'Диаметр слива, мм'=>'Диаметр',
        'Диаметр стартера, мм'=>'Диаметр',
        'Диаметр цилиндра, мм'=>'Диаметр',
        'Диаметр, мм'=>'Диаметр',
        'Диаметр,мм'=>'Диаметр',
        'Внешний диаметр, мм'=>'Внешний диаметр',
        'Внутренний диамтр щеточного диска, мм'=>'Внутренний диаметр',
        'Внутренний диаметр, мм'=>'Внутренний диаметр',
        'Двигатель, тип'=>'Тип двигателя',
        'Длина балонного ключа, мм'=>'Длина',
        'Длина болтореза, мм'=>'Длина',
        'Длина гвоздодера, мм'=>'Длина',
        'Длина жгута для ремонта бк шин, мм'=>'Длина',
        'Длина зажимов, мм'=>'Длина',
        'Длина заплатки, мм'=>'Длина',
        'Длина изоленты, мм'=>'Длина',
        'Длина стартера, мм'=>'Длина',
        'Длина щетки, мм'=>'Длина',
        'Длина, мм'=>'Длина',
        'Емкость АКБ, А·ч'=>'',
        'Емкость тестируемых батарей, А/ч'=>'',
        ...
        'Максимальный ток зажимов, А'=>'Максимальный ток',
        'Максимальный ток запуска, А'=>'Максимальный ток',
        'Максимальный ток зарядки, А'=>'Максимальный ток',
        'Максимальный ток потребления, А'=>'Максимальный ток',
        'Материал'=>'Материал',
        'Мощность генератора, Вт'=>'Мощность',
        'Мощность паяльника, Вт'=>'Мощность',
        'Мощность, Вт'=>'Мощность',
        'Мощность, W'=>'Мощность',
        'Напряжение питания, В'=>'Напряжение',
        'Напряжение, В'=>'Напряжение',
        'Номинальное напряжение аккумулятора, В'=>'Напряжение',
        'Номинальное напряжение, В'=>'Напряжение',
        'Объем бачка, л'=>'Объем',
        'Объем, л'=>'Объем',
        'Размер, мм'=>'Размер',
        ...
        'Ток втягивающей обмотки, А'=>'Сила тока',
        'Ток выпрямляемый, не менее, А'=>'Сила тока',
        'Ток удерживающей обмотки, А'=>'Сила тока',
        'Ток холодного пуска DIN, А'=>'Сила тока',
        'Ток холодного пуска EN, А'=>'Сила тока',
        'Топливо, тип'=>'Тип топлива',
        'Ход поршня, мм'=>'Ход поршня',
        'Цвет'=>'Цвет',
        'Цвет основной'=>'Цвет',
        'Цветовая температура, K'=>'Цветовая температура',
        ...
        'Ширина заплатки, мм'=>'Ширина',
        'Ширина ленты, мм'=>'Ширина',
        'Ширина шины'=>'Ширина',
        'Ширина, мм'=>'Ширина'
    ];
