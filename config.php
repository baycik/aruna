<?php
// HTTP
define('HTTP_SERVER', 'http://localhost:888/aruna/public_html/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost:888/aruna/public_html/');

// DIR
define('DIR_APPLICATION', 'W:\iSell\www\aruna/public_html/catalog/');
